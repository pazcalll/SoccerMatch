...
public class MainActivity extends AppCompatActivity {
    private ImageButton homeImage;
    private ImageButton awayImage;
    private ImageButton addHomePlayer;
    private ImageButton addAwayPlayer;
    private Button startBtn;
    private EditText homeTeam;
    private EditText awayTeam;
    private TextView homePlayerNumber;
    private TextView awayPlayerNumber;
    private ListView homePlayerList;
    private ListView awayPlayerList;
...
//                if (list2.get(0).equalsIgnoreCase("add 11 players")){
//                    list2.add(list2.get(0));
//                    list2.remove(0);
//                }
//                for (int i = 0; i < list2.size(); i++) {
//                    if (list2.get(i).equalsIgnoreCase("add 11 players")){
//                        list2.remove(i);
//                    }
//                }
...
//        ArrayAdapter<String> ad = new ArrayAdapter<String>(this, R.layout.activity_main, R.id.listItem, homePlayer);
//        for (int i = 0; i < 11; i++) {
//            homePlayer.add("Player Home "+i);
//            awayPlayer.add("Player Away"+i);
//        }
